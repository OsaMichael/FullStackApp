...
namespace FullStackApp.Core.Manager
{
    public class UserManager : IUserManager
    {
       ...
       //if i have more than two values i can pass it using model or creating a model for it
        ...
        //public Operation<bool> HasPermission(long userId, string permission)
        //{
        //    return Operation.Create(() =>
        //    {

        //        var uroles = _db.Query<UserRole>(_r => _r.User, _r => _r.Role)
        //            .Where(_ur => _ur.UserId == userId).ToList().Select(_ur => _ur.Role.Name)
        //            .ToArray();
        ...
        //        //    });
        //        //}
        //        //public Operation<UserModel> ValidateAllUsers(string userName, string password)
        //        //{
        //        //    return Operation.Create(() =>
        //        //    {
        //        //        // Validate Applicant Login
        //        //        var isAppExist = _db.Query<ApplicantSignOn>().Where(a => a.UserName == userName && a.Password == password).FirstOrDefault();

        //        //        if (isAppExist != null)
        //        //        {
        //        //            var appEntity = _db.Query<Applicant>().Where(a => a.UserName == userName).FirstOrDefault();
        //        //            return new UserModel
        //        //            {
        //        //                Othernames = appEntity.OtherNames,
        //        //                Surname = appEntity.Surname,
        //        //                UserName = appEntity.UserName,
        //        //                Email = appEntity.Email,
        //        //                ImageUrl = new byte[0],
        //        //                RoleName = "Applicant",
        //        //                UserId = appEntity.ApplicantNo
        //        //            };
        //        //        }

        //        //        //Validate Student Login
        //        //        var isStuExist = _db.Query<StudentSignOn>().Where(s => s.UserName == userName && s.Password == password).FirstOrDefault();

        //        //        if (isAppExist != null)
        //        //        {
        //        //            var appEntity = _db.Query<Student>().Where(s => s.UserName == userName).FirstOrDefault();
        //        //            return new UserModel
        //        //            {
        //        //                Othernames = appEntity.OtherNames,
        //        //                Surname = appEntity.Surname,
        ...
        //        //                ImageUrl = new byte[0],
        //        //                RoleName = "Student",
        //        //                UserId = appEntity.MatricNumber
        //        //            };
        //        //        }

        //        //        //Validate Admin Login
        //        //        var roleName = "";
        //        //        var userEntity = _db.Query<User>().Where(u => u.Username == userName && u.Password == password).FirstOrDefault();
        //        //        var roles = _db.Query<UserRole>(u => u.Role).Where(a => a.UserId == userEntity.UserId).Select(u => u.Role.RoleName).ToList();
        //        //        if (roles.Contains("Bursary"))
        //        //        {
        //        //            roleName = "Bursary";
        //        //        }
        //        //        else
        ...
        //        //        if (userEntity != null)
        //        //        {
        //        //            //return new UserModel(isAdminExist);
        //        //            return new UserModel
        //        //            {
        //        //                Othernames = userEntity.Othernames,
        ...
        //        //        var user = _db.Query<User>().Where(u => u.Username == username).FirstOrDefault();
        ...
        //        //public Operation<PermissionModel[]> AddPermissionsToRole(int roleId, string[] roles, string createdBy)
        //        //{
        //        //    return Operation.Create(() =>
        //        //    {
